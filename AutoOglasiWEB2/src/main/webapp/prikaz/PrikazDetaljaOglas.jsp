...
<body>
	<jsp:include page="/template/header.jsp"></jsp:include>
		...
		<div class="oglas-detalji-container">
			<h1 class="naslov">${prikaziOglas.automobil.proizvodjac.naziv}
				${prikaziOglas.automobil.model.naziv}</h1>
		...
		<div class="oglas-kontakt-container">
			...
			<form action="/AutoOglasi/oglasi/sacuvajOmiljeni" method="post">
				...
				<label for="napomena">Napomena: </label> <input id="napomena"
					type="text" name="napomena">
			...
			<form action="/AutoOglasi/oglasi/posaljiPoruku" method="post">
				<input type="hidden" name="idKorisnik"
					...
					name="idOglas" value="${prikaziOglas.idOglas}"> <label
					for="sadrzaj">Poruka
					prodavcu(${prikaziOglas.clan.korisnickoIme}): </label> <input id="sadrzaj"
					type="text" name="sadrzaj">
